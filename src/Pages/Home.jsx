    ...
    <>
      ...
      <div className='container '>
        ...
        <div className='bg-[#ffa5cf] w-2/3 h-auto items-center m-auto rounded-3xl'>
          <div>
            <h2 className='text-center font-Passions text-6xl text-black sm:text-8xl md:text-8xl lg:text-8xl '>¡Welcome!</h2>
          </div>
          <div className='w-4/12 h-1/5 m-auto'>
            <img className='scale-150 mt-12 sm:scale-95 md:scale-95 lg:scale-75' src={nutone} alt="" />
          </div>
          <div>
            <h3 className='font-Passions text-center text-6xl text-black mt-10 sm:text-8xl md:text-8xl lg:text-8xl'>¡To my Portfolio!</h3>
          </div>
          <div>
